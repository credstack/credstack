...
func (x *OIDCConfiguration) Reset() {
	*x = OIDCConfiguration{}
	mi := &file_wellknown_oidc_proto_msgTypes[0]
...
func (*OIDCConfiguration) Descriptor() ([]byte, []int) {
	return file_wellknown_oidc_proto_rawDescGZIP(), []int{0}
}
...
var File_wellknown_oidc_proto protoreflect.FileDescriptor

const file_wellknown_oidc_proto_rawDesc = "" +
	"\n" +
	"\x14wellknown/oidc.proto\x12\twellknown\"\xb8\x02\n" +
	...
	"\x15registration_endpoint\x18\a \x01(\tR\x14registrationEndpointB5Z3github.com/credstack/credstack/pkg/models/wellknownb\x06proto3"

var (
	file_wellknown_oidc_proto_rawDescOnce sync.Once
	file_wellknown_oidc_proto_rawDescData []byte
)

func file_wellknown_oidc_proto_rawDescGZIP() []byte {
	file_wellknown_oidc_proto_rawDescOnce.Do(func() {
		file_wellknown_oidc_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_wellknown_oidc_proto_rawDesc), len(file_wellknown_oidc_proto_rawDesc)))
	})
	return file_wellknown_oidc_proto_rawDescData
}

var file_wellknown_oidc_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_wellknown_oidc_proto_goTypes = []any{
	(*OIDCConfiguration)(nil), // 0: wellknown.OIDCConfiguration
}
var file_wellknown_oidc_proto_depIdxs = []int32{
...
func init() { file_wellknown_oidc_proto_init() }
func file_wellknown_oidc_proto_init() {
	if File_wellknown_oidc_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_wellknown_oidc_proto_rawDesc), len(file_wellknown_oidc_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_wellknown_oidc_proto_goTypes,
		DependencyIndexes: file_wellknown_oidc_proto_depIdxs,
		MessageInfos:      file_wellknown_oidc_proto_msgTypes,
	}.Build()
	File_wellknown_oidc_proto = out.File
	file_wellknown_oidc_proto_goTypes = nil
	file_wellknown_oidc_proto_depIdxs = nil
}
