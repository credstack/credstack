...
// 	protoc        v3.12.4
// source: token/ticket.proto

package token

import (
	api "github.com/credstack/credstack/pkg/models/api"
	application "github.com/credstack/credstack/pkg/models/application"
	request "github.com/credstack/credstack/pkg/models/request"
...
func (x *AuthenticationTicket) Reset() {
	*x = AuthenticationTicket{}
	mi := &file_token_ticket_proto_msgTypes[0]
...
func (*AuthenticationTicket) Descriptor() ([]byte, []int) {
	return file_token_ticket_proto_rawDescGZIP(), []int{0}
}
...
var File_token_ticket_proto protoreflect.FileDescriptor

const file_token_ticket_proto_rawDesc = "" +
	"\n" +
	"\x12token/ticket.proto\x12\x05token\x1a\x1dapplication/application.proto\x1a\rapi/api.proto\x1a\x13request/token.proto\"\xaa\x01\n" +
	...
	"\rtoken_request\x18\x03 \x01(\v2\x15.request.TokenRequestR\ftokenRequestB1Z/github.com/credstack/credstack/pkg/models/tokenb\x06proto3"

var (
	file_token_ticket_proto_rawDescOnce sync.Once
	file_token_ticket_proto_rawDescData []byte
)

func file_token_ticket_proto_rawDescGZIP() []byte {
	file_token_ticket_proto_rawDescOnce.Do(func() {
		file_token_ticket_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_token_ticket_proto_rawDesc), len(file_token_ticket_proto_rawDesc)))
	})
	return file_token_ticket_proto_rawDescData
}

var file_token_ticket_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_token_ticket_proto_goTypes = []any{
...
var file_token_ticket_proto_depIdxs = []int32{
...
func init() { file_token_ticket_proto_init() }
func file_token_ticket_proto_init() {
	if File_token_ticket_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_token_ticket_proto_rawDesc), len(file_token_ticket_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_token_ticket_proto_goTypes,
		DependencyIndexes: file_token_ticket_proto_depIdxs,
		MessageInfos:      file_token_ticket_proto_msgTypes,
	}.Build()
	File_token_ticket_proto = out.File
	file_token_ticket_proto_goTypes = nil
	file_token_ticket_proto_depIdxs = nil
}
