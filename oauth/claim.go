...
*/
func NewClaims(iss string, aud string) jwt.RegisteredClaims {
...
*/
func NewClaimsWithSubject(iss string, aud string, sub string) jwt.RegisteredClaims {
	ret := NewClaims(iss, aud)
	ret.Subject = sub
