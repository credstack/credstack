...
func (x *TokenIntrospectResponse) Reset() {
	*x = TokenIntrospectResponse{}
	mi := &file_token_introspect_proto_msgTypes[0]
...
func (*TokenIntrospectResponse) Descriptor() ([]byte, []int) {
	return file_token_introspect_proto_rawDescGZIP(), []int{0}
}
...
var File_token_introspect_proto protoreflect.FileDescriptor

const file_token_introspect_proto_rawDesc = "" +
	"\n" +
	"\x16token/introspect.proto\x12\x05token\"\x88\x01\n" +
	...
	"\x03exp\x18\x05 \x01(\x03R\x03expB1Z/github.com/credstack/credstack/pkg/models/tokenb\x06proto3"

var (
	file_token_introspect_proto_rawDescOnce sync.Once
	file_token_introspect_proto_rawDescData []byte
)

func file_token_introspect_proto_rawDescGZIP() []byte {
	file_token_introspect_proto_rawDescOnce.Do(func() {
		file_token_introspect_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_token_introspect_proto_rawDesc), len(file_token_introspect_proto_rawDesc)))
	})
	return file_token_introspect_proto_rawDescData
}

var file_token_introspect_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_token_introspect_proto_goTypes = []any{
	(*TokenIntrospectResponse)(nil), // 0: token.TokenIntrospectResponse
}
var file_token_introspect_proto_depIdxs = []int32{
...
func init() { file_token_introspect_proto_init() }
func file_token_introspect_proto_init() {
	if File_token_introspect_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_token_introspect_proto_rawDesc), len(file_token_introspect_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_token_introspect_proto_goTypes,
		DependencyIndexes: file_token_introspect_proto_depIdxs,
		MessageInfos:      file_token_introspect_proto_msgTypes,
	}.Build()
	File_token_introspect_proto = out.File
	file_token_introspect_proto_goTypes = nil
	file_token_introspect_proto_depIdxs = nil
}
