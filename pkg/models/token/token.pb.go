...
const file_token_token_proto_rawDesc = "" +
	"\n" +
	"\x11token/token.proto\x12\x05token\x1a\x1fgoogle/protobuf/timestamp.proto\"\xd3\x02\n" +
	"\x05Token\x12\x10\n" +
	...
	"\x05scope\x18\t \x01(\tR\x05scopeB1Z/github.com/credstack/credstack/pkg/models/tokenb\x06proto3"
