...
func (x *TokenRequest) Reset() {
	*x = TokenRequest{}
	mi := &file_request_token_proto_msgTypes[0]
...
func (*TokenRequest) Descriptor() ([]byte, []int) {
	return file_request_token_proto_rawDescGZIP(), []int{0}
}
...
var File_request_token_proto protoreflect.FileDescriptor

const file_request_token_proto_rawDesc = "" +
	"\n" +
	"\x13request/token.proto\x12\arequest\"\xc2\x01\n" +
	...
	"\fredirect_uri\x18\x06 \x01(\tR\vredirectUriB3Z1github.com/credstack/credstack/pkg/models/requestb\x06proto3"

var (
	file_request_token_proto_rawDescOnce sync.Once
	file_request_token_proto_rawDescData []byte
)

func file_request_token_proto_rawDescGZIP() []byte {
	file_request_token_proto_rawDescOnce.Do(func() {
		file_request_token_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_request_token_proto_rawDesc), len(file_request_token_proto_rawDesc)))
	})
	return file_request_token_proto_rawDescData
}

var file_request_token_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_request_token_proto_goTypes = []any{
	(*TokenRequest)(nil), // 0: request.TokenRequest
}
var file_request_token_proto_depIdxs = []int32{
...
func init() { file_request_token_proto_init() }
func file_request_token_proto_init() {
	if File_request_token_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_request_token_proto_rawDesc), len(file_request_token_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_request_token_proto_goTypes,
		DependencyIndexes: file_request_token_proto_depIdxs,
		MessageInfos:      file_request_token_proto_msgTypes,
	}.Build()
	File_request_token_proto = out.File
	file_request_token_proto_goTypes = nil
	file_request_token_proto_depIdxs = nil
}
