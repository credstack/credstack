...
func (x *OAuthConfiguration) Reset() {
	*x = OAuthConfiguration{}
	mi := &file_wellknown_oauth_proto_msgTypes[0]
...
func (*OAuthConfiguration) Descriptor() ([]byte, []int) {
	return file_wellknown_oauth_proto_rawDescGZIP(), []int{0}
}
...
var File_wellknown_oauth_proto protoreflect.FileDescriptor

const file_wellknown_oauth_proto_rawDesc = "" +
	"\n" +
	"\x15wellknown/oauth.proto\x12\twellknown\"\x8d\x02\n" +
	...
	"\bjwks_uri\x18\x06 \x01(\tR\ajwksUriB5Z3github.com/credstack/credstack/pkg/models/wellknownb\x06proto3"

var (
	file_wellknown_oauth_proto_rawDescOnce sync.Once
	file_wellknown_oauth_proto_rawDescData []byte
)

func file_wellknown_oauth_proto_rawDescGZIP() []byte {
	file_wellknown_oauth_proto_rawDescOnce.Do(func() {
		file_wellknown_oauth_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_wellknown_oauth_proto_rawDesc), len(file_wellknown_oauth_proto_rawDesc)))
	})
	return file_wellknown_oauth_proto_rawDescData
}

var file_wellknown_oauth_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_wellknown_oauth_proto_goTypes = []any{
	(*OAuthConfiguration)(nil), // 0: wellknown.OAuthConfiguration
}
var file_wellknown_oauth_proto_depIdxs = []int32{
...
func init() { file_wellknown_oauth_proto_init() }
func file_wellknown_oauth_proto_init() {
	if File_wellknown_oauth_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_wellknown_oauth_proto_rawDesc), len(file_wellknown_oauth_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_wellknown_oauth_proto_goTypes,
		DependencyIndexes: file_wellknown_oauth_proto_depIdxs,
		MessageInfos:      file_wellknown_oauth_proto_msgTypes,
	}.Build()
	File_wellknown_oauth_proto = out.File
	file_wellknown_oauth_proto_goTypes = nil
	file_wellknown_oauth_proto_depIdxs = nil
}
