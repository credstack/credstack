...
const file_user_credential_proto_rawDesc = "" +
	"\n" +
	"\x15user/credential.proto\x12\x04user\"\xbc\x01\n" +
	...
	"saltLengthB0Z.github.com/credstack/credstack/pkg/models/userb\x06proto3"
...
var file_user_credential_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
