...
const file_request_register_proto_rawDesc = "" +
	"\n" +
	"\x16request/register.proto\x12\arequest\"\x86\x01\n" +
	"\x13UserRegisterRequest\x12\x14\n" +
	"\x05email\x18\x01 \x01(\tR\x05email\x12\x1a\n" +
	"\busername\x18\x02 \x01(\tR\busername\x12\x1a\n" +
	"\bpassword\x18\x03 \x01(\tR\bpassword\x12!\n" +
	"\fphone_number\x18\x04 \x01(\tR\vphoneNumberB3Z1github.com/credstack/credstack/pkg/models/requestb\x06proto3"

var (
	file_request_register_proto_rawDescOnce sync.Once
	file_request_register_proto_rawDescData []byte
)

func file_request_register_proto_rawDescGZIP() []byte {
	file_request_register_proto_rawDescOnce.Do(func() {
		file_request_register_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_request_register_proto_rawDesc), len(file_request_register_proto_rawDesc)))
	})
	return file_request_register_proto_rawDescData
}

var file_request_register_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_request_register_proto_goTypes = []any{
...
func file_request_register_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_request_register_proto_rawDesc), len(file_request_register_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
