...
func (x *PermissionScope) Reset() {
	*x = PermissionScope{}
	mi := &file_api_scope_proto_msgTypes[0]
...
func (*PermissionScope) Descriptor() ([]byte, []int) {
	return file_api_scope_proto_rawDescGZIP(), []int{0}
}
...
var File_api_scope_proto protoreflect.FileDescriptor

const file_api_scope_proto_rawDesc = "" +
	"\n" +
	"\x0fapi/scope.proto\x12\x03api\x1a\x13header/header.proto\"\x88\x01\n" +
	...
	"\x05value\x18\x04 \x01(\tR\x05valueB/Z-github.com/credstack/credstack/pkg/models/apib\x06proto3"

var (
	file_api_scope_proto_rawDescOnce sync.Once
	file_api_scope_proto_rawDescData []byte
)

func file_api_scope_proto_rawDescGZIP() []byte {
	file_api_scope_proto_rawDescOnce.Do(func() {
		file_api_scope_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_scope_proto_rawDesc), len(file_api_scope_proto_rawDesc)))
	})
	return file_api_scope_proto_rawDescData
}

var file_api_scope_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_api_scope_proto_goTypes = []any{
	(*PermissionScope)(nil), // 0: api.PermissionScope
	(*header.Header)(nil),   // 1: header.Header
}
var file_api_scope_proto_depIdxs = []int32{
...
func init() { file_api_scope_proto_init() }
func file_api_scope_proto_init() {
	if File_api_scope_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_scope_proto_rawDesc), len(file_api_scope_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_api_scope_proto_goTypes,
		DependencyIndexes: file_api_scope_proto_depIdxs,
		MessageInfos:      file_api_scope_proto_msgTypes,
	}.Build()
	File_api_scope_proto = out.File
	file_api_scope_proto_goTypes = nil
	file_api_scope_proto_depIdxs = nil
}
