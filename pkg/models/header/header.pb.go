...
const file_header_header_proto_rawDesc = "" +
	"\n" +
	"\x13header/header.proto\x12\x06header\"\xee\x01\n" +
	"\x06Header\x12\x1e\n" +
	"\n" +
	...
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B2Z0github.com/credstack/credstack/pkg/models/headerb\x06proto3"

var (
	file_header_header_proto_rawDescOnce sync.Once
	file_header_header_proto_rawDescData []byte
)

func file_header_header_proto_rawDescGZIP() []byte {
	file_header_header_proto_rawDescOnce.Do(func() {
		file_header_header_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_header_header_proto_rawDesc), len(file_header_header_proto_rawDesc)))
	})
	return file_header_header_proto_rawDescData
}

var file_header_header_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_header_header_proto_goTypes = []any{
...
func file_header_header_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_header_header_proto_rawDesc), len(file_header_header_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
