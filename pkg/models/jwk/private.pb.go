...
// 	protoc        v3.12.4
// source: jwk/private.proto

package jwk

import (
	header "github.com/credstack/credstack/pkg/models/header"
...
func (x *PrivateJSONWebKey) Reset() {
	*x = PrivateJSONWebKey{}
	mi := &file_jwk_private_proto_msgTypes[0]
...
func (*PrivateJSONWebKey) Descriptor() ([]byte, []int) {
	return file_jwk_private_proto_rawDescGZIP(), []int{0}
}
...
var File_jwk_private_proto protoreflect.FileDescriptor

const file_jwk_private_proto_rawDesc = "" +
	"\n" +
	"\x11jwk/private.proto\x12\x03jwk\x1a\x13header/header.proto\"\xbf\x01\n" +
	...
	"\baudience\x18\x06 \x01(\tR\baudienceB/Z-github.com/credstack/credstack/pkg/models/jwkb\x06proto3"

var (
	file_jwk_private_proto_rawDescOnce sync.Once
	file_jwk_private_proto_rawDescData []byte
)

func file_jwk_private_proto_rawDescGZIP() []byte {
	file_jwk_private_proto_rawDescOnce.Do(func() {
		file_jwk_private_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_jwk_private_proto_rawDesc), len(file_jwk_private_proto_rawDesc)))
	})
	return file_jwk_private_proto_rawDescData
}

var file_jwk_private_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_jwk_private_proto_goTypes = []any{
	(*PrivateJSONWebKey)(nil), // 0: jwk.PrivateJSONWebKey
	(*header.Header)(nil),     // 1: header.Header
}
var file_jwk_private_proto_depIdxs = []int32{
...
func init() { file_jwk_private_proto_init() }
func file_jwk_private_proto_init() {
	if File_jwk_private_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_jwk_private_proto_rawDesc), len(file_jwk_private_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_jwk_private_proto_goTypes,
		DependencyIndexes: file_jwk_private_proto_depIdxs,
		MessageInfos:      file_jwk_private_proto_msgTypes,
	}.Build()
	File_jwk_private_proto = out.File
	file_jwk_private_proto_goTypes = nil
	file_jwk_private_proto_depIdxs = nil
}
