...
// 	protoc        v3.12.4
// source: proto/key/private.proto
...
func (x *PrivateJSONWebKey) Reset() {
	*x = PrivateJSONWebKey{}
	mi := &file_proto_key_private_proto_msgTypes[0]
...
func (*PrivateJSONWebKey) Descriptor() ([]byte, []int) {
	return file_proto_key_private_proto_rawDescGZIP(), []int{0}
}
...
var (
	...
	file_proto_key_private_proto_rawDescData []byte
)

func file_proto_key_private_proto_rawDescGZIP() []byte {
	file_proto_key_private_proto_rawDescOnce.Do(func() {
		file_proto_key_private_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_key_private_proto_rawDesc), len(file_proto_key_private_proto_rawDesc)))
	})
	return file_proto_key_private_proto_rawDescData
}

var file_proto_key_private_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_proto_key_private_proto_goTypes = []any{
	(*PrivateJSONWebKey)(nil), // 0: key.PrivateJSONWebKey
	(*header.Header)(nil),     // 1: header.Header
}
var file_proto_key_private_proto_depIdxs = []int32{
	1, // 0: key.PrivateJSONWebKey.header:type_name -> header.Header
...
func init() { file_proto_key_private_proto_init() }
func file_proto_key_private_proto_init() {
	if File_proto_key_private_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_key_private_proto_rawDesc), len(file_proto_key_private_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_proto_key_private_proto_goTypes,
		DependencyIndexes: file_proto_key_private_proto_depIdxs,
		MessageInfos:      file_proto_key_private_proto_msgTypes,
	}.Build()
	File_proto_key_private_proto = out.File
	file_proto_key_private_proto_goTypes = nil
	file_proto_key_private_proto_depIdxs = nil
}
